...
<html lang="zh-TW">
 ...
 <link rel="stylesheet" href="css/register_copy.css?v=<?php echo time(); ?>"/>
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-4 col-sm-offset-4">
            <form class="register"><!-- 沒有設定  method 跟 action 交給之後的 ajax 處理-->
              ...
              <div class="type2">
                <input type="text" class="form-control" id="username" name="username" placeholder="User Name" style="font-size: 16px;" required>
              </div>
              </div>
              <div class="form-group">
              <label for="password">Password</label>
              <div class="type2">
                <input type="password" class="form-control" id="password" name="password" placeholder="Password" style="font-size: 16px;" required>
              </div>
              </div>
              <div class="form-group">
              <label for="confirm_password">Re Password</label>
              <div class="type2">
                <input type="password" class="form-control" id="confirm_password" name="password" placeholder="Re Password" style="font-size: 16px;" required>
              </div>
              </div>
              <div class="form-group">
              <label for="name">Name</label>
              <div class="type2">
                <input type="text" class="form-control" id="name" name="name" placeholder="Name" style="font-size: 16px;" required>
              </div>
              </div>
              <br>
              <div class="btn1">
     ...
     if ($("#password").val() != $("#confirm_password").val()) {
      ...
      $("#confirm_password").parent().addClass("has-error"); 
         ...
         $.ajax({
           ...
           if(data == "yes")
           {
             alert("Success,go to login automatically.");
            //註冊新增成功，轉跳到登入頁面。
